...
class ViewWikiTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from lazyvore.views import view_wiki
...
class ViewPageTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from lazyvore.views import view_page
        return view_page(request)

    def test_it(self):
        from lazyvore.models import Page
        request = testing.DummyRequest()
...
class AddPageTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from lazyvore.views import add_page
...
class EditPageTests(unittest.TestCase):
    ...
    def _callFUT(self, request):
        from lazyvore.views import edit_page
...
class FunctionTests(unittest.TestCase):
    ...
    def tearDown(self):
        del self.testapp
        from lazyvore.models import DBSession
        DBSession.remove()
